...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/06dbd1f1cf1dcbd59ff42.jpg",
        caption=f"""𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙩𝙝𝙚  𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙀𝙇𝙀𝙂𝙊𝘿""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍", url=f"https://t.me/bk_zt"),
                ],[
                InlineKeyboardButton(
                        "╞. 𝐒𝐨𝐮𝐫𝐜𝐞 .╡", url=f"https://t.me/cr_t2"),
                ]
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/06dbd1f1cf1dcbd59ff42.jpg",
        caption=f"""[𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙩𝙝𝙚 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙀𝙇𝙀𝙂𝙊𝘿 ](https://t.me/cr_t2)\n\n[𝙎𝙊𝙐𝙍𝘾𝙀 𝙊𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈](https://t.me/bk_zt)\n\n[𝙁𝘼𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈](https://t.me/cr_t2)\n\n[𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍 𝙎𝙊𝙐𝙍𝘾𝙀 ](https://t.me/bk_zt)""",
        reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
